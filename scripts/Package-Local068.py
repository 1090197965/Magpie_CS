...
- One XeSSFG effect, defaulting to 2× / AMD optical flow / Quality.
...
See XESSFG.md for verified GPU scope and remaining capture/display/quality checks, and XESSFG-COMPATIBILITY-NOTICE.md for source attribution. The RTX 5070 Ti synthetic SDR/zero-motion smoke test returned complete 2×/3×/4× SDK counts and successfully restored native 2× in the same process. Provider submission statistics are not display events. Real-game optical-flow, HDR, VRR and image-quality validation remains open.
